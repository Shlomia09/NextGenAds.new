...
// â”€â”€ Inline objective classifier (mirrors src/lib/objective.ts) â”€â”€
...
// â”€â”€ Meta custom_event_type â†’ { action_type, label } â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Helper: extract lead count from a Meta actions array â”€â”€
...
serve(async (req) => {
  ...
  try {
    ...
    for (const campaign of campaigns) {
      ...
      let page_views = 0; // landing_page_view â€” primary KPI for Traffic
      let atc = 0;        // add_to_cart â€” funnel metric for Sales

      // â”€â”€ Extract page views (landing_page_view) â€” all campaigns â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      // â”€â”€ Extract ATC (add_to_cart) â€” all campaigns â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      // â”€â”€ Resolve the actual conversion event configured in this campaign â”€â”€
      // Uses promoted_object.custom_event_type from Meta â€” the event the client actually set.
    ...
    // â”€â”€ Step 3: Daily breakdown per campaign (last 30 days) â”€â”€
    let dailyCount = 0;

    // Build map: campaign_id_external â†’ DB internal UUID
    ...
    // â”€â”€ Step 4: Ad-level insights â”€â”€
    let adsCount = 0;
    ...
    // â”€â”€ Step 5: Log system event â”€â”€
    try {
